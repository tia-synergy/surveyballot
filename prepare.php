                        ...
                        <div class="tabs">
                            <div class="tab-content">
								...
								<form class="fixed" id="company-form" name="company-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
									...
									<select id="country" name="country" class="country" onchange="oncountrySelect(this.value);">
