<?php
	...
	$selectAllClient = "select * from tb_client order by client_insertdate desc";
	$resAllClient = mysql_query($selectAllClient);
?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>Survey Ballot Admin | Client List</title>
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
									$i = 1;
									while($rowAllClient=mysql_fetch_array($resAllClient))
									{
									?>
										<tr>
											<td><?php echo $i;?></td>
											<td><a href="client_detail.php?clientid=<?php echo $rowAllClient['client_id']; ?>"><?php echo $rowAllClient['client_fullname'];?></a></td>
											<td><?php echo $rowAllClient['client_email'];?></td>
											<td><?php echo $rowAllClient['client_company'];?></td>
											<td>
												<?php
												if($rowAllClient['client_status']==1)
												{
												?>
											...
											<td><a href="customers.php?clientid=<?php echo $rowAllClient['client_id']; ?>">View</a></td>
										</tr>	
									<?php
										$i = $i+1;
									}
