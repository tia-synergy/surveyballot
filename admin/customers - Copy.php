			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Customers of <b><?php echo $rowClient['client_fullname']; ?></b></h3>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								?>
									<tr>
										<td><?php echo $i;?></td>
										<td><a href=""><?php echo $rowCustomers['customer_firstname'].' '.$rowCustomers['customer_lastname'];?></a></td>
										<td><?php echo $rowCustomers['customer_email'];?></td>
										<td><?php echo $rowCustomers['customer_company'];?></td>
										<td>
											<?php
											if($rowAllClient['customer_isActive']==1)
												echo "Active";
											else
												echo "InActive";
											?>
