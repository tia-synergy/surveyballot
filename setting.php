<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		elseif(!empty($_POST['email-submit']))
		{
			...
			$query1 = "update tb_emailwording set email_wording='$initialmail' where email_for='initial' and client_id='$client_id'";
			$resquery1 = mysql_query($query1);
				
			$query2 = "update tb_emailwording set email_wording='$subsequentmail' where email_for='subsequent' and client_id='$client_id'";
			$resquery2 = mysql_query($query2);
				
			$query3 = "update tb_emailwording set email_wording='$followupmail' where email_for='followup' and client_id='$client_id'";
									...
									<div class="row">
										<div class="span8">
											...
											<div class="span4">
												...
												<input class="span4" type="text" id="cwebsite" name="cwebsite" value="<?php echo $rowCompany['company_website'];?>" placeholder="Company Website" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"  required />
											</div>
										</div>
									</div>
									<div class="row">
                                ...
                                <form class="fixed" id="user-form" name="user-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
									<div class="span8">
										<div class="span4">
											...
											<input class="span4" type="text" id="fullname" name="fullname" value="<?php echo $rowClient['client_fullname'];?>" placeholder="Enter your full name" required />
										</div>
										<div class="span4">
											<label><strong>Email</strong></label>
											<input class="span4" type="text" id="email" name="email" value="<?php echo $rowClient['client_email'];?>" placeholder="Enter your email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required />
										</div>
									</div>
									<div class="span8" style="margin-left:0px;">
										<div class="span4">
