<?php
	...
	$selAllCustomer = "select * from tb_customer1";
	$resAllCustomer = mysql_query($selAllCustomer);
?>
<!DOCTYPE html>
<html>
	<head>
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									...
									?>
										<tr>
											<td><?php echo $i;?></td>
                                                                                        <td><a href="customer_detail.php?customer_id=<?php echo $rowAllCustomer['id']; ?>"><?php echo $rowAllCustomer['name'];?></a></td>
											<td><?php echo $rowAllCustomer['email'];?></td>
											<td><a href="customers_edit.php?customer_id=<?php echo $rowAllCustomer['id']; ?>"><i class="fa fa-edit"></i></a>
											<td><a href="send_survey.php?customer_id=<?php echo $rowAllCustomer['id']; ?>">Send</a>
											</td>
										</tr>	
									<?php
										$i = $i+1;
