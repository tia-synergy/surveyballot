					...
					<div>
						<div align="center" style="padding-top:40px;">
							...
							<div align="left" style="margin-left:15px;">
								...
								<div>
									<input type="radio" id="a1" name="recommend_response" value="1" /><label>I would go out of my way to recommend <?php echo $rowclient['client_company'];?> </label><br />
									<input type="radio" id="a2" name="recommend_response" value="2" /><label> I would recommend <?php echo $rowclient['client_company'];?> if asked  </label><br />
									<input type="radio" id="a3" name="recommend_response" value="3" /><label> I wouldn't feel comfortable recommending <?php echo $rowclient['client_company'];?></label>
								</div>	
								<input id="response-submit" name="response-submit" type="submit" class="btn" value="Submit" />
								<a href="unsubscribe.php?token='$token'">Unsubscribe from list</a>
							</div>
						</div>
					</div>
				</form>
