				...
				<form class="fixed" id="testimonial-form" name="testimonial-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
					<div>
						<div align="center" style="padding-top:40px;">
							...
							<h5 style="padding-bottom:30px;">We look forward to continuing to improve our service, and getting our scores again in future.</h5>
						</div>
					</div>
				</form>
			</div><!-- end .row -->
