	...
	*/
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		if(!empty($_POST['comment-submit']))
		{
			...
			$updateHeartbeat = "update tb_customerheartbeat set comment='$comment' where email_token='$token'";
	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div class="row">
				...
				<form class="fixed" id="comment-form" name="comment-form" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
					<div>
						<div align="center" style="padding-top:40px;">
							...
							<h5 style="margin-bottom:30px;">Please add some comment.</h5>
							<div align="left" style="margin-left:15px;">
								<textarea name="comment"></textarea>
								<input id="comment-submit" name="comment-submit" type="submit" class="btn" value="Submit" />
							</div>
						</div>
					</div>
				</form>
