...
<body>
						...
						<div>
							...
							<div class="span6">
								...
								<span style="float:right;">
								    ...
								    <a href="#" class="btn" data-reveal-id="sendnewCustomer">Send New Survey</a>
									...
									{										
										...
										?>
											<tr>
										        ...
										        <!--<td><a href="deletenew.php?client_id=$row[client_id]" 
	...
	<div id="sendnewCustomer" class="reveal-modal" style="/*width:525px;*/" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
		...
		<div class="row">
			<form class="fixed" id="customer-form" name="customer-form" action="customer-detail.php" 
			method="post">
